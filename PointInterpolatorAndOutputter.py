...
def interpolateAndOutput(verts, colors, times):
    ...
    perform_interpolation(times, xs, Xs)
    perform_interpolation(times, ys, Ys)
    perform_interpolation(times, rs, Rs)
    perform_interpolation(times, gs, Gs)
    perform_interpolation(times, bs, Bs)
...
def main():
    ...
    colors = [(255, 255, 0.),(0., 255, 255),(255, 0., 255),(0., 0., 0.)]
    times = [0,1,2,3]
    interpolateAndOutput(verts, colors, times)
